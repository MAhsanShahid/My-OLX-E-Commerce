...
<div id="section">
	...
	<span class="style2">
	Black Lebra
	</span><a href="animal.php" target="_self"><img src="http://localhost:8080/khareedLo/Images\do.jpg" style="width:100%;height:100%;border:0"/></a><span class="style2">
	Rs. 25,000
	</span></div>
	...
	<span class="style2">
	Persion Cat
	</span><a href="animal.php" target="_self"><img src="http://localhost:8080/khareedLo/Images\ct.jpg" style="width:100%;height:100%;border:0"/></a><span class="style2">
	Rs. 20,000
	</span></div>
	...
	<span class="style2">
	Macow Pair
	</span><a href="animal.php" target="_self"><img src="http://localhost:8080/khareedLo/Images\mc.jpg" style="width:100%;height:100%;border:0"/></a><span class="style2">
	Rs. 95,000
	</span></div>
