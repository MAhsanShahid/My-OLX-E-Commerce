http://localhost:8080/khareedLo/<?php
...
<div id="section">
	...
	<div class="cat" >
	<span class="style2">
	NIKON D7000 with 18-140mm
	</span><a href="electronic.php" target="_self"><img src="http://localhost:8080/khareedLo/Images\d.jpg" style="width:100%;height:100%;border:0"/></a><span class="style2">
	Rs. 85,000
	</span></div>
	...
	<span class="style2">
	Samsung 42'inch
	</span><a href="electronic.php" target="_self"><img src="http://localhost:8080/khareedLo/Images\s.jpg" style="width:100%;height:100%;border:0"/></a><span class="style2">
	Rs. 35,000
	</span></div>
	...
	<span class="style2">
	Play Station 4
	</span><a href="electronic.php" target="_self"><img src="http://localhost:8080/khareedLo/Images\p.jpg" style="width:100%;height:100%;border:0"/></a><span class="style2">
	Rs. 30,000
	</span></div>
