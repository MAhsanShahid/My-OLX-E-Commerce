http://localhost:8080/khareedLo/http://localhost:8080/khareedLo/http://localhost:8080/khareedLo/http://localhost:8080/khareedLo/<?php
...
<body background="http://localhost:8080/khareedLo/http://localhost:8080/khareedLo/http://localhost:8080/khareedLo/http://localhost:8080/khareedLo/Images\colorful-shopping-bags.jpg" style=background-size:100%>

<div id="header">
  <ul id='a'>
  <li><div align="left"><a href="http://localhost:8080/khareedLo/index.php/Welcome/index" target="_self"><img src="http://localhost:8080/khareedLo/http://localhost:8080/khareedLo/http://localhost:8080/khareedLo/http://localhost:8080/khareedLo/Images\Untitled.png" width="218" height="136" /></a></li>
...
<div id="section">
	...
	<span class="style2">
	Apple iPhone 6
	</span><a href="mobile.php" target="_self"><img src="http://localhost:8080/khareedLo/http://localhost:8080/khareedLo/http://localhost:8080/khareedLo/Images\iph6.jpg" style="width:100%;height:100%;border:0"/></a><span class="style2">
	Rs. 20,000
	</span></div>
	...
	<span class="style2">
	Sony Xperia Z
	</span><a href="mobile.php" target="_self"><img src="http://localhost:8080/khareedLo/http://localhost:8080/khareedLo/Images\i6.jpg" style="width:100%;height:100%;border:0"/></a><span class="style2">
	Rs. 25,000
	</span></div>
	...
	<span class="style2">
	Samsung Tablet X
	</span><a href="mobile.php" target="_self"><img src="http://localhost:8080/khareedLo/Images\l2.jpg" style="width:100%;height:100%;border:0"/></a><span class="style2">
	Rs. 15,000
	</span></div>
