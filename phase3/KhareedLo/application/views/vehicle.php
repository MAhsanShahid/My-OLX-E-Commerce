...
</head>http://localhost:8080/khareedLo/
...
<div id="section">
	...
	<span class="style2">
	Suzuki Mehran
	</span><a href="vehicle.php" target="_self"><img src="http://localhost:8080/khareedLo/Images\c.jpg" style="width:100%;height:100%;border:0"/></a><span class="style2">
	Rs. 400,000
	</span></div>
	...
	<span class="style2">
	Toyota Corolla
	</span><a href="vehicle.php" target="_self"><img src="http://localhost:8080/khareedLo/Images\t.jpg" style="width:100%;height:100%;border:0"/></a><span class="style2">
	Rs. 10,00,000
	</span></div>
	...
	<span class="style2">
	Toyota Prius
	</span><a href="vehicle.php" target="_self"><img src="http://localhost:8080/khareedLo/Images\ts.jpg" style="width:100%;height:100%;border:0"/></a><span class="style2">
	Rs. 2500,000
	</span></div>
